    ...
    return (
      <>
        <div className="login-card">
          ...
          <Input ref={this.userInput} style={{ marginBottom: "15px", textAlign: "center", backgroundColor:'transparent' }} placeholder="نام کاربری" />
          <Input ref={this.passInput} style={{ marginBottom: "15px", textAlign: "center", backgroundColor:'transparent' }} type="password" placeholder="رمز عبور" />
          {
